...
전체 변경 내역은 [Releases](https://github.com/UsernameTron/everything-claude-code/releases)에서 확인하세요.
...
[GitHub 앱 설치](https://github.com/apps/skill-creator) | [ecc.tools]()
...
Claude Code에서 `/security-scan`을 사용하거나, [GitHub Action](https://github.com/UsernameTron/agentshield)으로 CI에 추가하세요.
...
- **요약 가이드 (여기서 시작):** [The Shorthand Guide to Everything Claude Code](/status/2012378465664745795)
- **상세 가이드 (고급):** [The Longform Guide to Everything Claude Code](/status/2014040193557471352)
- **팔로우:** []()
