...
[![Forks](https://img.shields.io/github/forks/UsernameTron/everything-claude-code?style=flat)](https://github.com/UsernameTron/everything-claude-code/network/members)
[![Contributors](https://img.shields.io/github/contributors/UsernameTron/everything-claude-code?style=flat)](https://github.com/UsernameTron/everything-claude-code/graphs/contributors)
...
* **修复了直觉导入内容丢失问题** — `parse_instinct_file()` 在 `/instinct-import` 期间会静默丢弃 frontmatter 之后的所有内容（Action, Evidence, Examples 部分）。已由社区贡献者 @ericcai0814 修复 ([#148](https://github.com/UsernameTron/everything-claude-code/issues/148), [#161](https://github.com/UsernameTron/everything-claude-code/pull/161))
...
完整的更新日志请参见 [Releases](https://github.com/UsernameTron/everything-claude-code/releases)。
...
```bash
# Add marketplace
/plugin marketplace add UsernameTron/everything-claude-code
...
git clone https://github.com/UsernameTron/everything-claude-code.git
...
[安装 GitHub 应用](https://github.com/apps/skill-creator) | [ecc.tools]()
...
**历史背景：** 这已导致此仓库中多次修复/还原循环（[#29](https://github.com/UsernameTron/everything-claude-code/issues/29), [#52](https://github.com/UsernameTron/everything-claude-code/issues/52), [#103](https://github.com/UsernameTron/everything-claude-code/issues/103)）。Claude Code 版本之间的行为发生了变化，导致了混淆。我们现在有一个回归测试来防止这种情况再次发生。
...
```json
{
  "extraKnownMarketplaces": {
    "everything-claude-code": {
      "source": {
        "source": "github",
        "repo": "UsernameTron/everything-claude-code"
      }
    }
  },
  "enabledPlugins": {
...
这是最常见的问题。**不要在 `.claude-plugin/plugin.json` 中添加 `"hooks"` 字段。** Claude Code v2.1+ 会自动从已安装的插件加载 `hooks/hooks.json`。显式声明它会导致重复检测错误。参见 [#29](https://github.com/UsernameTron/everything-claude-code/issues/29), [#52](https://github.com/UsernameTron/everything-claude-code/issues/52), [#103](https://github.com/UsernameTron/everything-claude-code/issues/103)。
...
* **Codex**: 对 macOS 应用和 CLI 的一流支持，带有适配器漂移防护和 SessionStart 回退。参见 PR [#257](https://github.com/UsernameTron/everything-claude-code/pull/257)。
