...
```bash
# 1. Fork ve clone
gh repo fork UsernameTron/everything-claude-code --clone
...
- **Issue'lar:** [github.com/UsernameTron/everything-claude-code/issues](https://github.com/UsernameTron/everything-claude-code/issues)
- **X/Twitter:** []()
