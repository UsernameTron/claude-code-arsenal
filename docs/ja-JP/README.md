...
- **instinctインポート時のコンテンツ喪失を修正** — `/instinct-import`実行時に`parse_instinct_file()`がfrontmatter後のすべてのコンテンツ（Action、Evidence、Examplesセクション）を暗黙的に削除していた問題を修正。コミュニティ貢献者@ericcai0814により解決されました（[#148](https://github.com/UsernameTron/everything-claude-code/issues/148), [#161](https://github.com/UsernameTron/everything-claude-code/pull/161)）
...
完全なチェンジログは[Releases](https://github.com/UsernameTron/everything-claude-code/releases)を参照してください。
...
[GitHub アプリをインストール](https://github.com/apps/skill-creator) | [ecc.tools]()
...
Claude Codeで`/security-scan`を実行、または[GitHub Action](https://github.com/UsernameTron/agentshield)でCIに追加できます。
...
**背景:** これは本リポジトリで複数の修正/リバート循環を引き起こしました（[#29](https://github.com/UsernameTron/everything-claude-code/issues/29), [#52](https://github.com/UsernameTron/everything-claude-code/issues/52), [#103](https://github.com/UsernameTron/everything-claude-code/issues/103)）。Claude Codeバージョン間で動作が変わったため混乱がありました。今後を防ぐため回帰テストがあります。
...
- **簡潔ガイド（まずはこれ）:** [Everything Claude Code 簡潔ガイド](/status/2012378465664745795)
- **詳細ガイド（高度）:** [Everything Claude Code 詳細ガイド](/status/2014040193557471352)
- **フォロー:** []()
