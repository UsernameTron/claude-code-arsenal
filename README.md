...
[Install GitHub App](https://github.com/apps/skill-creator) | [ecc.tools]()
...
Use `/security-scan` in Claude Code to run it, or add to CI with the [GitHub Action](https://github.com/UsernameTron/agentshield).
...
**History:** This has caused repeated fix/revert cycles in this repo ([#29](https://github.com/UsernameTron/everything-claude-code/issues/29), [#52](https://github.com/UsernameTron/everything-claude-code/issues/52), [#103](https://github.com/UsernameTron/everything-claude-code/issues/103)). The behavior changed between Claude Code versions, leading to confusion. We now have a regression test to prevent this from being reintroduced.
...
This is the most common issue. **Do NOT add a `"hooks"` field to `.claude-plugin/plugin.json`.** Claude Code v2.1+ automatically loads `hooks/hooks.json` from installed plugins. Explicitly declaring it causes duplicate detection errors. See [#29](https://github.com/UsernameTron/everything-claude-code/issues/29), [#52](https://github.com/UsernameTron/everything-claude-code/issues/52), [#103](https://github.com/UsernameTron/everything-claude-code/issues/103).
</details>
...
- **Codex**: First-class support for both macOS app and CLI, with adapter drift guards and SessionStart fallback. See PR [#257](https://github.com/UsernameTron/everything-claude-code/pull/257).
...
- **Shorthand Guide (Start Here):** [The Shorthand Guide to Everything Claude Code](/status/2012378465664745795)
- **Longform Guide (Advanced):** [The Longform Guide to Everything Claude Code](/status/2014040193557471352)
- **Security Guide:** [Security Guide](./the-security-guide.md) | [Thread](/status/2033263813387223421)
- **Follow:** []()
